        ...
        <div class="card-layout">
          ...
          <div class="card-content">
            <div class="top-row">
              ...
              ${t.length?V`<div class="top-right-icons">
                    ${this._renderEntityIcons(t)}
                  </div>`:W}
            </div>
            ${o?V`
                  <div class="bottom-row">
                    <div class="bottom-left-icons">
                      ${this._renderEntityIcons(e)}
                    </div>
                    <div class="bottom-right-icons">
                      ${this._renderEntityIcons(i)}
                    </div>
                  </div>
                `:W}
          </div>
